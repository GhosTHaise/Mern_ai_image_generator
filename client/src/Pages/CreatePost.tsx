  ...
  const generateImage = async() =>{
    if(form.prompt){
      try{
          ...
          const response = await fetch("https://ai-mern-imagegenerator.onrender.com/api/v1/dalle",{
            method : "POST",
            headers :{
    ...
    <section className='max-w-7xl mx-auto'>
        <div className=''>
              ...
              <p className='mt-2 text-[#666e75] text-[16px] max-w-[500px]'>
                    Create imaginative immaginative and 
                    visually stunning through DALL-E AI and share them with the community
              </p>
        </div>
        <form 
        ...
        >
            <div className='flex flex-col gap-5'>
                ...
                />
                <div className='relative bg-gray-50 border botder-gray-300
                ...
                '>
                    ...
                    {generatingImg && (
                      <div className='absolute inset-0 z-0 flex justify-center
                          items-center bg-[rgba(0,0,0,0.5)] rouned-lg'>
                        <Loader />
                      </div>
                    )}
                </div>
